...
final class App_Router {
    private const ROUTES=['explore','play','games','game-builder','game-play','map','offline','trips','adventure-ai','adventures','saved','trip-builder','active-trip','trip-mode','past-trips','recaps','profile','profile-settings','search','leaderboard','achievements','friends','activity','challenges','journal','explorer-journal','completed','my-photos','trails','events','food','top-sights','destinations'];
    ...
    public static function render_screen():string{switch(self::$route){
        ...
        case'adventures':return class_exists('TNG_OS\\Modules\\Destinations\\Adventure_AI')?\TNG_OS\Modules\Destinations\Adventure_AI::render_library():self::fallback('Saved Adventures','Reopen your private Tennessee itineraries.');
