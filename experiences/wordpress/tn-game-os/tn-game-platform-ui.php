...
final class TNG_Platform_UI {
    ...
    public static function enqueue(): void {
        ...
        wp_enqueue_style('tng-platform-ui', $base . 'assets/css/platform-ui.css', [], '0.1.0');
        wp_enqueue_script('tng-platform-ui', $base . 'assets/js/platform-ui.js', [], '0.1.0', true);
    }
    ...
    public static function navigation(): void {
        ...
        $items = [
            ['Explore','⌂',home_url('/')], ['Map','⌖',home_url('/map/')], ['Play','▶',home_url('/play/'),'primary'], ['Trips','◇',home_url('/trips/')], ['Profile','○',$profile]
        ];
