...
add_action('plugins_loaded',static function():void{
    ...
    foreach([
        'TNG_Platform_UI'=>'tn-game-platform-ui.php','TNG_Trip_Data'=>'tn-game-trip-data.php','TNG_Trip_Builder_UI'=>'tn-game-trip-builder-ui.php','TNG_Active_Trip_UI'=>'tn-game-active-trip-ui.php','TNG_Past_Trips_UI'=>'tn-game-past-trips-ui.php','TNG_Trip_Dock'=>'tn-game-trip-dock.php','TNG_Play_UI'=>'tn-game-play-ui.php','TNG_Games_UI'=>'tn-game-games-ui.php','TNG_Game_Builder_UI'=>'tn-game-builder-ui.php','TNG_Game_Runtime_UI'=>'tn-game-runtime-ui.php','TNG_Map_UI'=>'tn-game-map-ui.php','TNG_Trips_UI'=>'tn-game-trips-ui.php','TNG_Profile_UI'=>'tn-game-profile-ui.php','TNG_Settings_UI'=>'tn-game-settings-ui.php','TNG_Search_UI'=>'tn-game-search-ui.php','TNG_Progress_UI'=>'tn-game-progress-ui.php','TNG_Social_UI'=>'tn-game-social-ui.php','TNG_Challenges_UI'=>'tn-game-challenges-ui.php','TNG_Library_UI'=>'tn-game-library-ui.php','TNG_Directory_UI'=>'tn-game-directory-ui.php','TNG_Trail_UI'=>'tn-game-trail-ui.php','TNG_Place_UI'=>'tn-game-place-ui.php','TNG_Event_UI'=>'tn-game-event-ui.php'
...
add_action('wp_enqueue_scripts',static function():void{
    ...
    wp_enqueue_style('tng-app-router',TNG_OS_URL.'assets/css/app-router.css',['tng-platform-ui'],'3.3.0');
    ...
    if($route==='game-builder')wp_enqueue_style('tng-game-builder-ui',TNG_OS_URL.'assets/css/game-builder-ui.css',['tng-ui-kit'],'0.2.0');
    if($route==='game-play')wp_enqueue_style('tng-game-runtime-ui',TNG_OS_URL.'assets/css/game-runtime-ui.css',['tng-ui-kit'],'0.1.0');
