...
add_action('plugins_loaded', static function (): void {
    ...
    if (!class_exists('TNG_Game_Builder_UI')) require_once TNG_OS_PATH . 'tn-game-builder-ui.php';
...
add_action('wp_enqueue_scripts', static function (): void {
    ...
    if ($route === 'games') wp_enqueue_style('tng-games-ui', TNG_OS_URL . 'assets/css/games-ui.css', ['tng-ui-kit'], '0.2.0');
    if ($route === 'game-builder') wp_enqueue_style('tng-game-builder-ui', TNG_OS_URL . 'assets/css/game-builder-ui.css', ['tng-ui-kit'], '0.1.0');
