...
add_action('wp_enqueue_scripts',static function():void{
    ...
    wp_enqueue_style('tng-app-router',TNG_OS_URL.'assets/css/app-router.css',['tng-platform-ui'],'3.5.0');
