...
add_action('wp_enqueue_scripts',static function():void{
    ...
    wp_enqueue_style('tng-app-router',TNG_OS_URL.'assets/css/app-router.css',['tng-platform-ui'],'3.8.3');
    ...
    if(in_array($route,['trips','adventures','saved','trip-builder','active-trip','trip-mode','past-trips','recaps'],true))wp_enqueue_style('tng-trips-ui',TNG_OS_URL.'assets/css/trips-ui.css',['tng-ui-kit'],'0.3.0');
    if($route==='adventure-ai')wp_enqueue_style('tng-adventure-ai',TNG_OS_URL.'assets/css/adventure-ai.css',['tng-ui-kit'],TNG_OS_VERSION);
    if($route==='adventures')wp_enqueue_style('tng-saved-adventures',TNG_OS_URL.'assets/css/saved-adventures.css',['tng-trips-ui'],TNG_OS_VERSION);
    ...
    if($route==='adventure-ai')wp_enqueue_script('tng-adventure-ai',TNG_OS_URL.'assets/js/adventure-ai.js',[],TNG_OS_VERSION,true);
    if($route==='adventures')wp_enqueue_script('tng-saved-adventures',TNG_OS_URL.'assets/js/saved-adventures.js',[],TNG_OS_VERSION,true);
