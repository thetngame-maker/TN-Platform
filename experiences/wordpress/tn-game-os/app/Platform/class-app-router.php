...
final class App_Router {
    private const ROUTES=['explore','play','games','game-builder','map','trips','saved','trip-builder','active-trip','trip-mode','past-trips','profile','profile-settings','search','leaderboard','achievements','friends','activity','challenges','journal','explorer-journal','completed','my-photos','trails','events','food','top-sights','destinations'];
