...
final class Plugin {
    ...
    public function boot(): void {
        ...
        foreach ([
            ...
            'app/Modules/Concerts/class-concert-platform-sync.php',
            'app/Modules/Concerts/class-concert-review-workflow.php',
        ...
        $module_classes = [
            ...
            \TNG_OS\Modules\Concerts\Concert_Platform_Sync::class,
            \TNG_OS\Modules\Concerts\Concert_Review_Workflow::class,
