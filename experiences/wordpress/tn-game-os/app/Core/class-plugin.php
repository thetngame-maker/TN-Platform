...
final class Plugin {
    ...
    public function boot(): void {
        ...
        foreach ([
            ...
            'app/Modules/Frontend/class-platform-ui.php',
        ...
        $module_classes = [
            ...
            \TNG_OS\Modules\Sources\Local_Discovery::class,
            \TNG_OS\Modules\Sources\Local_Discovery_Destination_Linker::class,
            \TNG_OS\Modules\Sources\Town_Scanner::class,
            ...
            \TNG_OS\Modules\Frontend\Platform_UI::class,
