...
final class Plugin {
    ...
    public function boot(): void {
        ...
        foreach ([
            ...
            'app/Modules/Frontend/class-community-photos.php',
            ...
            'app/Modules/Admin/class-production-smoke-tests.php',
            'app/Modules/Admin/class-cleanup-audit.php',
            'app/Modules/Admin/class-service-tag-manager.php',
            'app/Modules/Admin/class-ai-content-manager.php',
        ...
        $module_classes = [
            ...
            \TNG_OS\Modules\Frontend\Community_Photos::class,
            ...
            \TNG_OS\Modules\Admin\Production_Smoke_Tests::class,
            \TNG_OS\Modules\Admin\Cleanup_Audit::class,
            \TNG_OS\Modules\Admin\Service_Tag_Manager::class,
            \TNG_OS\Modules\Admin\AI_Content_Manager::class,
