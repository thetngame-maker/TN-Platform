...
final class Plugin {
    ...
    public function boot(): void {
        ...
        foreach ([
            ...
            'app/Modules/Entities/class-destination-intelligence.php',
            'app/Modules/Entities/class-relationship-suggestions.php',
            'app/Modules/Entities/class-graph-automation.php',
            'app/Modules/Entities/class-quest-intelligence.php',
            'app/Modules/Entities/class-quest-pipeline-stabilizer.php',
            'app/Modules/Entities/class-quest-create-bridge.php',
            'app/Modules/Entities/class-quest-blueprint-request-guard.php',
            'app/Modules/Entities/class-quest-blueprint-studio.php',
            'app/Modules/Entities/class-gameplay-engine.php',
            'app/Modules/Entities/class-quest-library.php',
            'app/Modules/Entities/class-player-progress.php',
            'app/Modules/Entities/class-spatial-integrity.php',
            'app/Modules/Entities/class-spatial-coordinate-resolver.php',
            ...
            'app/Modules/Frontend/class-world-discovery-engine.php',
            'app/Modules/Frontend/class-world-discovery-claims.php',
            'app/Modules/Frontend/class-world-quest-launch-fix.php',
            'app/Modules/Frontend/class-runtime-navigation-engine.php',
            'app/Modules/Frontend/class-living-world-engine.php',
            'app/Modules/Frontend/class-dynamic-discovery-engine.php',
            'app/Modules/Frontend/class-dynamic-challenge-claims.php',
            'app/Modules/Frontend/class-admin-gameplay-test-bridge.php',
            'app/Modules/Frontend/class-runtime-bootstrap-recovery.php',
            'app/Modules/Frontend/class-runtime-direct-bootstrap-fix.php',
            'app/Modules/Concerts/class-concert-trip-pages.php',
            'app/Modules/Concerts/class-concert-intelligence.php',
            'app/Modules/Concerts/class-concert-source-manager.php',
        ...
        $module_classes = [
            ...
            \TNG_OS\Modules\Entities\Destination_Intelligence::class,
            \TNG_OS\Modules\Entities\Relationship_Suggestions::class,
            \TNG_OS\Modules\Entities\Graph_Automation::class,
            \TNG_OS\Modules\Entities\Quest_Intelligence::class,
            \TNG_OS\Modules\Entities\Quest_Pipeline_Stabilizer::class,
            \TNG_OS\Modules\Entities\Quest_Create_Bridge::class,
            \TNG_OS\Modules\Entities\Quest_Blueprint_Request_Guard::class,
            \TNG_OS\Modules\Entities\Quest_Blueprint_Studio::class,
            \TNG_OS\Modules\Entities\Gameplay_Engine::class,
            \TNG_OS\Modules\Entities\Quest_Library::class,
            \TNG_OS\Modules\Entities\Player_Progress::class,
            \TNG_OS\Modules\Entities\Spatial_Integrity::class,
            \TNG_OS\Modules\Entities\Spatial_Coordinate_Resolver::class,
            ...
            \TNG_OS\Modules\Frontend\Quest_Runtime_Page::class,
            \TNG_OS\Modules\Frontend\Quest_Map_Layout_Fix::class,
            \TNG_OS\Modules\Frontend\World_Engine::class,
            \TNG_OS\Modules\Frontend\World_Discovery_Engine::class,
            \TNG_OS\Modules\Frontend\World_Discovery_Claims::class,
            \TNG_OS\Modules\Frontend\World_Quest_Launch_Fix::class,
            \TNG_OS\Modules\Frontend\Runtime_Navigation_Engine::class,
            \TNG_OS\Modules\Frontend\Living_World_Engine::class,
            \TNG_OS\Modules\Frontend\Dynamic_Discovery_Engine::class,
            \TNG_OS\Modules\Frontend\Dynamic_Challenge_Claims::class,
            \TNG_OS\Modules\Frontend\Admin_Gameplay_Test_Bridge::class,
            \TNG_OS\Modules\Frontend\Runtime_Bootstrap_Recovery::class,
            \TNG_OS\Modules\Frontend\Runtime_Direct_Bootstrap_Fix::class,
            \TNG_OS\Modules\Concerts\Concert_Trip_Pages::class,
            \TNG_OS\Modules\Concerts\Concert_Intelligence::class,
            \TNG_OS\Modules\Concerts\Concert_Source_Manager::class,
